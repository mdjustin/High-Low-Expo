...
***Rename text box*** - Allows you to set a custom suffix for both the high and low poly buttons, by default they have the standard ones used within substance painter.
